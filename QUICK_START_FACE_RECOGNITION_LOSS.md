...
# Place in: ./pretrained/adaface/adaface_ir50_webface4m.ckpt
```
...
python eval_face_verification.py \
    ...
    --face_model=ir_50 \
    --face_weights=./pretrained/adaface/adaface_ir50_webface4m.ckpt \
...
ls -lh ./pretrained/adaface/adaface_ir50_webface4m.ckpt
